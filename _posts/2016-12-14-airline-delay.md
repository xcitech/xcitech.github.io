...
The Jupyter notebooks are in the Github repository. If you wish to follow along, please follow the Notebooks here.


## Exploring Historical flight delays

The best measure for on-time performance of a flight is ARR_DELAY, which is the difference in minutes between scheduled and actual arrival time. Early arrivals show negative numbers. I started by visualizing the ARR_DELAY for the top ten airlines sorted by the number of flights they had in our dataset.
...
> Flight paths delayed more than 10 minutes on average. Darker lines represent higher average delays.
